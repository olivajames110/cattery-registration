    ...
    return (
        <div className="input-container">
            ...
            <div ref={containerRef} className="electronic-signature-container">
                <SignatureCanvas ref={ref => (sigCanvas = ref)} penColor="green" canvasProps={{ width: containerWidth, height: 200, className: "sigCanvas" }} />
                <div className="additional-text-container">
                    <button onClick={clear} className="clear-btn">
                        Clear
                    </button>
                    <button onClick={createImage} className="clear-btn">
                        Create
                    </button>
                </div>
            </div>
